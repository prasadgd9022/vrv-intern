    ...
    return (
        <div className="mb-4">
            ...
            <div className="flex mb-4 w-2/3">
                ...
                />
                <button onClick={handleAddUser} className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white px-4 py-2 rounded-lg hover:opacity-90 transition duration-300 ml-2 shadow-md">
                    Create User
                </button>
            </div>
            ...
            <table className="min-w-full border border-gray-200 rounded-lg overflow-hidden">
                <thead>
                    <tr className="bg-gradient-to-r from-purple-100 to-indigo-100">
                        <th className="border-b p-3 text-purple-900 text-left">Name</th>
                        <th className="border-b p-3 text-purple-900 text-left">Role</th>
                        <th className="border-b p-3 text-purple-900 text-left">Status</th>
                        <th className="border-b p-3 text-purple-900 text-left">Actions</th>
                    </tr>
                </thead>
                <tbody>
            ...
            {isModalOpen && (
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                    <div className="bg-white p-6 rounded-lg shadow-lg">
                        ...
                        <button onClick={handleSaveUser} className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white px-4 py-2 rounded-lg hover:opacity-90 transition duration-300 mr-2 shadow-md">
                            Save
                        </button>
